          ...
          <div className="content__container relative">
              <div className="container">
                  <div className='flex justify-center items-center flex-col-reverse xl:justify-normal lg:justify-between lg:flex-row'>
                      ...
                      <img src="../about/Rectangle 55.png" alt="house" className='ml-[107px] hidden xl:block'/>
                      <img src="../about/Rectangle 56.png" alt="house" className='xl:absolute right-0 top-0 w-[456px] h-[380px] object-cover '/>
                  </div>
              </div>
          ...
          <div className="content__container relative">
              <div className='container mt-[103px]'>
                  <div className='flex xl:items-end xl:justify-end lg:justify-between flex-col lg:flex-row items-center justify-center '>
                      <img src="../about/Rectangle 57.png" alt="img" className='xl:absolute xl:w-[696px] xl:h-[443px] left-0 top-0 w-[456px] h-[450px] object-cover'/>
