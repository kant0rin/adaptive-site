            ...
            <div className="container flex flex-col items-center justify-center xl:block">
                ...
                <div className='flex xl:-mt-2 mt-2 items-center justify-center flex-col xl:flex-row'>
                    <div className='flex items-center flex-wrap'>
                        <img src="/public/catalog/Funke_Gruppe250_1_%20копия%201.png" alt="funke_group"/>
                        <img src="/public/catalog/image%2010.png" alt="proplex" className='ml-2'/>
                        <img src="/public/catalog/image 5.png" alt="tatprof" className='ml-2'/>
                        <img src="/public/catalog/image 6.png" alt="alprof" className='ml-2'/>
                        <img src="/public/catalog/image 7.png" alt="vitraj" className='ml-2'/>
                        <img src="/public/catalog/image 8.png" alt="crystalis" className='ml-2'/>
                        <img src="/public/catalog/image 9.png" alt="kale" className='ml-2'/>
                    </div>
